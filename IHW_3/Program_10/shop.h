...
#define OBSERVER_FIFO_BASE "/tmp/shop_observer_"
...
typedef struct {
    ...
    int observer_count;            // Количество активных наблюдателей
    int observer_pids[MAX_OBSERVERS]; // PID активных наблюдателей
} shop_t;
